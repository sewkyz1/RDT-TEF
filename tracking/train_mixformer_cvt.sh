...
# # python tracking/train.py --script mixformer_cvt_online --config baseline --save_dir /media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz/save/checkpoints --mode multiple --nproc_per_node 2
