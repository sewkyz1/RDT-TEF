...
parser.add_argument('--dataset_name', type=str, default='RGBD_1K', help='Name of config file.')
...
"""MixFormer"""
trackers.extend(trackerlist(name='mixformer_cvt_online', parameter_name=args.tracker_param, dataset_name=args.dataset_name,
