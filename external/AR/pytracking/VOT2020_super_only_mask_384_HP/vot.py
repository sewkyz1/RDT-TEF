...
class VOT(object):
    ...
    def report(self, region, confidence = None):  # yuanban save in 0922
        """
    ...
    # def report(self, region, confidence = None):  # new
    #     """
    #     Report the tracking results to the client
    #     Arguments:
    #         # region: region for the frame
