...
# from pytracking.utils.loading import load_network  # yuan 
from external.AR.pytracking.utils.loading import load_network 
# from ltr.data.processing_utils_SE import sample_target_SE, transform_image_to_crop_SE, map_mask_back  # yuan
...
class RefineModule(object):
    ...
    def initialize(self, frame1, bbox1):
        ...
        bbox1_crop_tensor = transform_image_to_crop_SE(bbox1_tensor, bbox1_tensor, h_f, w_f, crop_sz).cuda()  # 转到256*256的坐标
    ...
    def refine(self, Cframe, Cbbox, mode='all', test=False):
        ...
        # return output_dict if test else output_dict[mode]  # yuan
        return output_dict
