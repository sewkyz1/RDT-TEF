...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        for data_iter_step, data in enumerate(loader, 1):
            ...
            batch_size = data['template_images_rgb'].shape[loader.stack_dim]
    ...
    def train_epoch(self):
        ...
        #     if self.epoch % loader.epoch_interval == 0:  # train every epoch val only epoch%5==0
        #         # 2021.1.10 Set epoch
        ...
        self.loaders[1].epoch_interval = 1000  # ban val
