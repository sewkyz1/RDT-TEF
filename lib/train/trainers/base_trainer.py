...
class BaseTrainer:
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    # only save the last 10 checkpoints  # only save the last 10 checkpoints
                    save_every_epoch = getattr(self.settings, "save_every_epoch", False)

                    if epoch > (max_epochs - 40) or save_every_epoch or epoch % 5 == 0:  # save checkpoints
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        actor_type = type(self.actor).__name__
        net_type = type(net).__name__
        print('code of load checkpoint is in MixFormer-main-kyz/lib/train/trainers/base_trainer.py')
