...
def main():
    ...
    # parser.add_argument('--script', default='mixformer_cvt', type=str, help='Name of the train script.')
    parser.add_argument('--script', default='mixformer_cvt_online', type=str, help='Name of the train script.')
    parser.add_argument('--config', default='baseline', type=str, help="Name of the config file.")    
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', default='/media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz/save/checkpoints', type=str, help='the directory to save checkpoints and logs')
