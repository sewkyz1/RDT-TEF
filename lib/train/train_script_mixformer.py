...
def run(settings):
    ...
    elif settings.script_name == "mixformer_cvt_online":
    ...
    if settings.script_name in ["mixformer_cvt", "mixformer_vit", "mixformer_convmae"]:
        ...
        objective = {'ciou': ciou_loss, 'l1': l1_loss, 'score': BCEWithLogitsLoss(), 'focal': focal_loss}
        loss_weight = {'ciou': cfg.TRAIN.IOU_WEIGHT, 'l1': cfg.TRAIN.L1_WEIGHT, 'score': cfg.TRAIN.SCORE_WEIGHT, 'focal': 1.}
