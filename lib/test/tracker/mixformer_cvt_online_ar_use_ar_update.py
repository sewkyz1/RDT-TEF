...
# mixformer_cvt_online_ar_use_ar_update  choose ar pred_bbox as self.state
import sys
...
class MixFormerOnline(BaseTracker):
    ...
    def track(self, image_rgb, image_d, info: dict = None):
        ...
        if self.params.AR:
            ...
            self.state = [pred_bbox[0],pred_bbox[1],pred_bbox[2],pred_bbox[3]]           
