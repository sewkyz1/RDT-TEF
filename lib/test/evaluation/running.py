...
def run_dataset(dataset, trackers, debug=False, threads=0, num_gpus=8):
    ...
    if mode == 'sequential':
        ...
        # for seq in dataset:
        #     # if seq.name=='robot_human_corridor_noocc_2':
        #     # if seq.name == 'bicycle2_outside':
        #     # if seq.name == 'box_room_occ_1':
        #     # if seq.name == 'box_darkroom_noocc_1':
        #     # if seq.name == 'bottle_box':
        #     if seq.name == 'two_tennis_balls':
        #     # if seq.name == 'trashcans_room_occ_1_B':
        #     # if seq.name == 'person_outside':
        #     # if seq.name == 'cartman':
        #     # if seq.name == 'robot_corridor_occ_1':
        #     # if seq.name == 'humans_shirts_room_occ_1_A':    
        #     # if seq.name=='backpack_robotarm_lab_occ':
        #     # if seq.name=='boxes_backpack_room_occ_1':
        #     # if seq.name=='paperpunch':
        #     # if seq.name=='robot_lab_occ':
        #     # if seq.name=='box_darkroom_noocc_6' or seq.name=='robot_human_corridor_noocc_2' or seq.name=='box1_outside' or seq.name=='box_darkroom_noocc_4':  # or seq.name=='backpack_robotarm_lab_occ':
        #         for tracker_info in trackers:
        #             run_sequence(seq, tracker_info, debug=debug)
                    

    elif mode == 'parallel':
        param_list = [(seq, tracker_info, debug, num_gpus) for seq, tracker_info in product(dataset, trackers)]  # kan kan za hui shi
