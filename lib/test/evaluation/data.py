...
class Sequence:
    ...
    def __init__(self, name, frames_rgb, frames_depth, dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                 object_class=None, target_visible=None, object_ids=None, multiobj_mode=False):
        self.name = name
        # self.frames = frames
        ...
        self.init_data = self._construct_init_data(init_data)  # meigai
        self._ensure_start_frame()  # meigai
