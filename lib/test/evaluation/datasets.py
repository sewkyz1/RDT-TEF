...
dataset_dict = dict(
    ...
    rgbd_1k=DatasetInfo(module=pt % "rgbd1k", class_name="RGBD_1kDataset", kwargs=dict()),  # new
    cdtb=DatasetInfo(module=pt % "cdtb", class_name="RGBD_1kDataset", kwargs=dict()),  # new
    depthtrack=DatasetInfo(module=pt % "depthtrack", class_name="RGBD_1kDataset", kwargs=dict()),  # new
)
