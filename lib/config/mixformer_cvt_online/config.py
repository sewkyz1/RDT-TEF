...
cfg.MODEL.FUSION.num_encoders = 4
# cfg.MODEL.FUSION.num_encoders = 5
# cfg.MODEL.FUSION.num_decoders = 1
cfg.MODEL.FUSION.num_decoders = 2
cfg.MODEL.FUSION.dim = 384
cfg.MODEL.FUSION.num_heads = 8
cfg.MODEL.FUSION.mlp_ratio = 4
cfg.MODEL.FUSION.qkv_bias = True
cfg.MODEL.FUSION.drop_rate = 0.1
cfg.MODEL.FUSION.attn_drop_rate = 0
...
# cfg.TRAIN.ONLY_BACKBONE_D = True
# cfg.TRAIN.ONLY_HEAD = True
# cfg.TRAIN.ONLY_FUSION = True
# cfg.TRAIN.ONLY_FUSION_WEIGHT = True
cfg.TRAIN.FUSION_AND_HEAD = True
# cfg.TRAIN.FUSION_AND_HEAD_AND_BACKBONE = True
# cfg.TRAIN.CENTER_HEAD = True
...
cfg.TRAIN.FUSION_MULTIPLIER = 0.01
...
# cfg.TEST.UPDATE_INTERVALS.VOT20RGBD = [200]
cfg.TEST.UPDATE_INTERVALS.CDTB = [200]
cfg.TEST.UPDATE_INTERVALS.RGBD_1K = [200]
cfg.TEST.UPDATE_INTERVALS.DEPTHTRACK = [200]
...
# cfg.TEST.ONLINE_SIZES.VOT20RGBD = [3]
cfg.TEST.ONLINE_SIZES.CDTB = [3]
cfg.TEST.ONLINE_SIZES.RGBD_1K = [3]
cfg.TEST.ONLINE_SIZES.DEPTHTRACK = [3]
