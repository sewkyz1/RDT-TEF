...
class FUSION(nn.Module):
    def __init__(self,  encoder, decoder):
        ...
        # self.learnable_weight = nn.Parameter(torch.zeros(2))
    ...
    def forward(self, x_rgb, x_depth, xpos_cat, xpos):
        ...
        # weight = self.softmax(self.learnable_weight)
        # x = weight[0]*x_rgb_ori + weight[1]*x_depth_ori
        x = 0.8*x_rgb + 0.2*x_depth  # gai ke xue xi
