...
class CrossAttention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., wh=0):
        super().__init__()
        ...
        self.q_ = nn.Linear(wh, wh, bias=qkv_bias)
        ...
        self.k = nn.Linear(wh, wh, bias=qkv_bias)
        self.v = nn.Linear(wh, wh, bias=qkv_bias)
