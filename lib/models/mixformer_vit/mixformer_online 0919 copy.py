...
def build_mixformer_vit_online_score(cfg, settings=None, train=True) -> MixFormerOnlineScore:
    ...
    # torch.save(backbone_d.state_dict(), '/media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz/backbone_d.pth')
    # print('/media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz')
    backbone_d.load_state_dict(torch.load('/media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz/backbone_d_trans.pth', map_location='cpu'), strict=True)
    print('/media/dell/f62e06ef-019a-4728-bd1f-906bcb35e057/MixFormer-main-kyz/backbone_d_trans.pth')
    print('backbone_d load success')
